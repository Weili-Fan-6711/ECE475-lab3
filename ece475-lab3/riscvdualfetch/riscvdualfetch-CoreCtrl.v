...
(
  ...
  // Steering Logic: toggles each time an instruction issues.
  // After a branch/jump redirect, the toggle naturally ends up at 0
  // (ir0_issued: 0->1, ir1/branch_issued: 1->0), so we always re-enter
  ...
  assign rfA_wen_out_Whl = rf0_wen_Whl;
  ...
  // Safely tie off Pipeline B outputs for Part 1
